$(function() {
    ...
    //城市切换
    (function() {
        var oCity = $('#header .city a');

        oCity.click(function() {
            oCity.removeClass('active').eq($(this).index()).addClass('active');
        });
    })();
});